...
class AgentSettingScreen extends StatefulWidget {
  AgentSettingScreen({super.key});

  @override
  State<AgentSettingScreen> createState() => _SettingScreenState();
}

class _SettingScreenState extends State<AgentSettingScreen> {
  bool themMode = false;
            ...
            children: [
              ...
              BigUserCard(
                ...
                cardActionWidget: SettingsItem(
                  ...
                  onTap: () {
                    context.router.push(ProfileRoute(profile: profile));
                  },
                ),
              ),
              SettingsGroup(
